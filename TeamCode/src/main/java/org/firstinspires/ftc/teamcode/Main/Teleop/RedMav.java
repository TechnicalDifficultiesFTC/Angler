...
@TeleOp(name = "Red TeleOp | MAV SUPPORT", group = "!TELEOP")
public class RedMav extends OpMode {
    String MOTM;
    Shooter shooter;
    Intake intake;
    Indexer indexer;
    ...
    Pose startingPose = Config.AutoPoses.defaultPoseRed;
    FireOnce fireOnce;
    ...
    public void init() {
        ...
        if (RedSixBallFront.endPose != null) {
            autoPose = RedSixBallFront.endPose;
            RedSixBallFront.endPose = null; // clear it
